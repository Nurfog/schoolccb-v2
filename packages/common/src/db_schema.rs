...
pub async fn run(pool: &PgPool) {
    ...
    let statements = vec![
        ...
        "CREATE TABLE IF NOT EXISTS colegios.employee_pension_funds (
            ...
            health_fixed_amount DECIMAL(12,2),
            created_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
        )",
        "CREATE TABLE IF NOT EXISTS colegios.payrolls (
            ...
            gratificacion DECIMAL(12,2) NOT NULL DEFAULT 0,
            non_taxable_earnings DECIMAL(12,2) NOT NULL DEFAULT 0,
            taxable_income DECIMAL(12,2) NOT NULL DEFAULT 0,
            afp_discount DECIMAL(12,2) NOT NULL DEFAULT 0,
            health_discount DECIMAL(12,2) NOT NULL DEFAULT 0,
            unemployment_discount DECIMAL(12,2) NOT NULL DEFAULT 0,
